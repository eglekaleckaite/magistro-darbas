...
cl <- makeCluster(3, outfile="simulPOPbagakas.txt") # number of cores. Notice 'outfile'
registerDoSNOW(cl)
...
mcmc <- foreach(ii = 1:N, .combine = rbind, .packages = pcg) %dopar% {
  ...
  res <- simPopMyFixed2(M = 20, formul ="Y2 ~ 1+W+X1+X1*W+(1+X1|IDSCHOOL)", 
...
save(mcmc, file = "Output/mcmcY2_simulMy_2000_800_400_800_20_fixed.RData")


# g00 <- rbind(mcmcRES(mcmc[,1], 4400),
#              mcmcRES(mcmc[,5], 4400),
#              mcmcRES(mcmc[,9], 4400),
#              mcmcRES(mcmc[,13], 4400),
#              mcmcRES(mcmc[,17], 4400),
#              mcmcRES(mcmc[,21], 4400),
#              mcmcRES(mcmc[,25], 4400))
# 
...
# 
# 
# sink("output_mcmcY2_simulMy_2000_2000_8000_2000_20.txt")
# cat("g00\n")
# print(g00)
# cat("g01\n")
# print(g01)
...
# pop <- makePOPW(800, sigma2 = 2000, tau00 = 800, tau01 = 400, tau11 = 800)
