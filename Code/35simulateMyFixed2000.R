...
mcmc <- foreach(ii = 1:N, .combine = rbind, .packages = pcg) %dopar% {
  ...
  res <- simPopMy2(M = 20, formul ="Y1 ~ 1+W+X1+X1*W+(1+X1|IDSCHOOL)", 
...
save(mcmc, file = "Output/mcmcY1_simulMy_2000_2000_1000_2000_20_add.RData")
...
# 
# 
# sink("output_mcmcY1_simulMy_2000_2000_20000_2000_20.txt")
# cat("g00\n")
# print(g00)
# cat("g01\n")
# print(g01)
...
# pop <- makePOPW(2000, sigma2 = 2000, tau00 = 2000, tau01 = 50, tau11 = 2000)
