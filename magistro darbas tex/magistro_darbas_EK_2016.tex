...
\newpage
\pdfbookmark[1]{SANTRAUKA / ABSTRACT}{abstract}
\section*{}%\currentpdfbookmark{SANTRAUKA / ABSTRACT}{sec:1}
...
\caption[Modelio (\ref{eq:wsimul}) simuliacijų įverčių statistikos]{Modelio (\ref{eq:wsimul}) simuliacijų įverčių statistikos. Statistikos plačiau aprašytos skyrelyje \ref{subsec:stat}.}
\label{table:wsimul}
\end{sidewaystable}
